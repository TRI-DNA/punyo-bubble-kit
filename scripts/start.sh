...
WORKING_DIR="/home/dna/punyo-bubble/scripts"
...
gnome-terminal --tab --title "Configure" -- bash -c "cd punyo-bubble/scripts; echo $mcu_msg1; echo $mcu_msg2; exec bash;"
gnome-terminal --tab --title "Pressure" -- bash -c "echo $header; echo $pressure_msg; echo $header; cd $WORKING_DIR; ./start_pressure1.sh;"
gnome-terminal --tab --title "Camera  " -- bash -c "echo $header; echo $camera_msg; echo $header; cd $WORKING_DIR; ./start_camera1.sh"
gnome-terminal --tab --title "Flow    " -- bash -c "echo $header; echo $flow_msg; echo $header; cd $WORKING_DIR; ./start_flow.sh"
gnome-terminal --tab --title "RQT     " -- bash -c "echo $header; echo $rqt_msg; echo $plot_msg; echo $header; cd $WORKING_DIR; ./start_rqt.sh"
gnome-terminal --tab --title "LED     " -- bash -c "echo $header; echo $led_msg; echo $header; cd $WORKING_DIR; ./start_led.sh"